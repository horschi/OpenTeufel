...
{
    public NPCOgdenEntity(final int posX, final int posY)
    {
        super(posX, posY);
    }
    ...
    {
        renderer.drawImageCentered(imageLoader.loadObjectImage("Towners\\twnf\\twnfn.cel", this.frameId), screenX, screenY, 16, 0, brightness);
    }
