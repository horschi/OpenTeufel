...
{
    public NPCPriestEntity(final int posX, final int posY)
    {
        super(posX, posY);
    }
    ...
    {
        renderer.drawImageCentered(imageLoader.loadObjectImage("Towners\\priest\\priest8.cel", this.frameId), screenX, screenY, 16, brightness);
    }
